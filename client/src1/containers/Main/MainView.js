...
import SuperPole from '../../modules/wifi/SuperPole';

import BlueTooth from '../../modules/connection/BlueTooth';
import Cable from '../../modules/connection/Cable';

// import DemoLink from '../../modules/connection/DemoLink';
...
import OnyxFirmware from '../../modules/onyxfirmware'
          ...
          <main className='main'>
            ...
            <div className='container-fluid'>
              <Switch>
                ...
                {/* <Redirect from='/wifi' to='/wifi/WiFi'/> */}
                <Route path='/wifi/WiFi' name='WiFi' component={WiFi}/>
                <Route path='/wifi/SuperPole' name='SuperPole' component={SuperPole}/>

                {/* <Route path='/connection/superpole' name='SuperPole' component={SuperPole}/> */}
                {/* <Route path='/connection/demolink' name='DemoLink' component={DemoLink}/> */}
                ...
                <Route path='/onyxfirmware' name='OnyxFirmware' component={OnyxFirmware}/>

                
                {/* <Route path='/demolink' name='DemoLink' component={DemoLink}/> */}
