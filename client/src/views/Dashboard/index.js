        ...
        <div className='row'>
              ...
              <div className='card-block pb-0'>
                <div className='btn-group float-right'>
                  <Dropdown isOpen={this.state.card1} toggle={() => {
                    ...
                    <button onClick={() => {
                      this.setState({ card1: !this.state.card1 });
                    }} className='btn btn-transparent active dropdown-toggle p-0' data-toggle='dropdown' aria-haspopup='true' aria-expanded={this.state.card1}>
          ...
          <div className='col-sm-6 col-lg-3'>
            <div className='card card-inverse card-info'>
              <div className='card-block pb-0'>
                <div className='btn-group float-right'>
                  <Dropdown isOpen={this.state.card2} toggle={() => {
                    this.setState({ card2: !this.state.card2 });
                  }}>
                    <button onClick={() => {
                      this.setState({ card2: !this.state.card2 });
                    }} className='btn btn-transparent active dropdown-toggle p-0' data-toggle='dropdown' aria-haspopup='true' aria-expanded={this.state.card2}>
                      <i className='icon-settings'></i>
                    </button>
                    <DropdownMenu>
                      <DropdownItem>Action</DropdownItem>
          ...
          <div className='col-sm-6 col-lg-3'>
            <div className='card card-inverse card-warning'>
              <div className='card-block pb-0'>
                <div className='btn-group float-right'>
                  <Dropdown isOpen={this.state.card3} toggle={() => {
                    this.setState({ card3: !this.state.card3 });
                  }}>
                    <button onClick={() => {
                      this.setState({ card3: !this.state.card3 });
                    }} className='btn btn-transparent active dropdown-toggle p-0' data-toggle='dropdown' aria-haspopup='true' aria-expanded={this.state.card3}>
                      <i className='icon-settings'></i>
                    </button>
                    <DropdownMenu>
                      <DropdownItem>Action</DropdownItem>
          ...
          <div className='card-block'>
            <div className='row'>
              ...
              <div className='col-sm-7 hidden-sm-down'>
                <button type='button' className='btn btn-primary float-right'><i className='icon-cloud-download'></i>
                </button>
                  ...
                  <div className='col-sm-6 col-lg-4'>
                    ...
                    <ul className='horizontal-bars type-2'>
                      ...
                      <li className='divider text-center'>
                        <button type='button' className='btn btn-sm btn-link text-muted' data-toggle='tooltip' data-placement='top' title='' data-original-title='show more'>
                    ...
                    <ul className='icons-list'>
                      <li>
                        ...
                        <div className='actions'>
                          <button type='button' className='btn btn-link text-muted'><i className='icon-settings'></i>
                          </button>
                        </div>
                      </li>
                      <li>
                      ...
                      <li className='divider text-center'>
                        <button type='button' className='btn btn-sm btn-link text-muted' data-toggle='tooltip' data-placement='top' title='show more'>
                          <i className='icon-options'></i></button>
                      </li>
                    </ul>
                  </div>
